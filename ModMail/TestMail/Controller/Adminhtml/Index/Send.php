...
namespace ModMail\TestMail\Controller\Adminhtml;
...
class Send extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('ModMail_TestMail::question');
    ...
    {
        return $this->_authorization->isAllowed('ModMail_TestMail::questions');
    }
}